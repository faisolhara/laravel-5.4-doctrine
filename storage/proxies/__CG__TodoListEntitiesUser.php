...
namespace DoctrineProxies\__CG__\TodoList\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \TodoList\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TodoList\\Entities\\User' . "\0" . 'id', '' . "\0" . 'TodoList\\Entities\\User' . "\0" . 'name', '' . "\0" . 'TodoList\\Entities\\User' . "\0" . 'email', '' . "\0" . 'TodoList\\Entities\\User' . "\0" . 'tasks', 'password', 'rememberToken'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTask(\TodoList\Entities\Task $task)
    {
